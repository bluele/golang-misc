...
import (
  ...
  "github.com/bluele/golang-misc/rpc/json2"
...
// Notification.
func (c *Counter) Incr(conn ws.Connection, req *IncrReq, res *json2.EmptyResponse) error {
...
func (c *Counter) Get(conn ws.Connection, req *GetReq, res *Counter) error {
